...
const styles = StyleSheet.create({
  ...
  restaurantLogo: { width: 52, height: 52, borderRadius: 14, backgroundColor: '#F5F5F5' },
  restaurantTitles: { flex: 1 },
  restaurantName: { fontSize: 20, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  restaurantTagline: { fontSize: 12, color: '#8A8A8A', fontFamily: 'Inter_400Regular', marginTop: 2 },

  locationRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  locationText: { fontSize: 12, color: '#8A8A8A', fontFamily: 'Inter_400Regular' },
  ...
  toggleText: { fontSize: 14, fontFamily: 'Inter_600SemiBold', color: '#5A5A5A' },
  ...
  popularName: { fontSize: 13, fontFamily: 'Inter_600SemiBold', color: '#1A1A1A', lineHeight: 18 },
  popularPrice: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  popularAddBtn: {
  ...
  orderTotal: { fontSize: 18, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  orderCount: { fontSize: 12, color: '#8A8A8A', fontFamily: 'Inter_400Regular' },
  orderBtn: {
    backgroundColor: '#00B14F', borderRadius: 14,
    paddingHorizontal: 28, paddingVertical: 14,
  },
  orderBtnText: { fontSize: 15, fontFamily: 'Inter_700Bold', color: '#FFFFFF' },
});
