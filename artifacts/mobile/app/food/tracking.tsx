...
const styles = StyleSheet.create({
  ...
  helpLink: { fontSize: 14, fontFamily: 'Inter_600SemiBold', color: '#00B14F' },

  scroll: { flex: 1 },

  // ETA card
  etaCard: {
    backgroundColor: '#FFFFFF', borderRadius: 16, margin: 16,
    padding: 18,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 6, elevation: 2,
  },
  etaTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 },
  etaTime: { fontSize: 22, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  ...
  etaStatus: { fontSize: 12, fontFamily: 'Inter_400Regular', color: '#9A9A9A' },
  riderAvatar: {
  ...
  stepInitial: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#FFFFFF' },
  trackerLine: { flex: 1, height: 3, backgroundColor: '#E0E0E0', marginHorizontal: 4 },
  trackerLineDone: { backgroundColor: '#00B14F' },
  kitchenNote: { fontSize: 12, fontFamily: 'Inter_400Regular', color: '#9A9A9A' },

  // Promo
  promoBanner: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#FFFFFF', borderRadius: 16, marginHorizontal: 16, marginTop: 0,
    paddingHorizontal: 14, paddingVertical: 14, gap: 10,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 6, elevation: 2,
  },
  promoIconWrap: {},
  promoIconCircle: {
    width: 36, height: 36, borderRadius: 18, backgroundColor: '#E8F5EE',
    alignItems: 'center', justifyContent: 'center',
  },
  promoText: { flex: 1, fontSize: 13, fontFamily: 'Inter_400Regular', color: '#1A1A1A', lineHeight: 18 },
  ...
  restaurantLogoText: { fontSize: 9, fontFamily: 'Inter_700Bold', color: '#FFFFFF', letterSpacing: 1 },
  restaurantInfo: { flex: 1 },
  restaurantName: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#1A1A1A', lineHeight: 20 },
  ...
  saveFavText: { flex: 1, fontSize: 13, fontFamily: 'Inter_400Regular', color: '#9A9A9A', lineHeight: 18 },
  ...
  viewSummaryText: { fontSize: 14, fontFamily: 'Inter_600SemiBold', color: '#1A1A1A' },
  divider: { height: 1, backgroundColor: '#F0F0F0', marginVertical: 12 },
  locationItem: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  locationText: { flex: 1, fontSize: 13, fontFamily: 'Inter_400Regular', color: '#9A9A9A' },
});
