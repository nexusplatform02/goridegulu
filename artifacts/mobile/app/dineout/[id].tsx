...
const styles = StyleSheet.create({
  ...
  logo: { width: 52, height: 52, borderRadius: 14, backgroundColor: '#F5F5F5' },
  titles: { flex: 1 },
  restaurantName: { fontSize: 20, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  tagline: { fontSize: 12, color: '#8A8A8A', fontFamily: 'Inter_400Regular', marginTop: 2 },
  metaRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  metaText: { fontSize: 12, color: '#8A8A8A', fontFamily: 'Inter_400Regular' },
  ratingText: { fontSize: 12, color: '#8A8A8A', fontFamily: 'Inter_400Regular', marginLeft: 3 },
  statsRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F8F8F8', borderRadius: 14, padding: 14 },
  ...
  sectionTitle: { fontSize: 18, fontFamily: 'Inter_700Bold', color: '#1A1A1A', marginBottom: 14 },
  subLabel: { fontSize: 13, fontFamily: 'Inter_500Medium', color: '#5A5A5A', marginBottom: 10 },
  ...
  guestText: { fontSize: 13, fontFamily: 'Inter_600SemiBold', color: '#5A5A5A' },
  ...
  timeText: { fontSize: 13, fontFamily: 'Inter_500Medium', color: '#5A5A5A' },
  timeTextActive: { color: '#00B14F', fontFamily: 'Inter_600SemiBold' },

  menuCard: {
    flexDirection: 'row', backgroundColor: '#FFFFFF', borderRadius: 14, overflow: 'hidden',
  ...
  menuName: { fontSize: 14, fontFamily: 'Inter_600SemiBold', color: '#1A1A1A' },
  menuDesc: { fontSize: 12, color: '#8A8A8A', fontFamily: 'Inter_400Regular', lineHeight: 17 },
  menuPrice: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#00B14F', marginTop: 2 },
  ...
  bookSummary: { fontSize: 12, color: '#8A8A8A', fontFamily: 'Inter_400Regular' },
  bookLabel: { fontSize: 15, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  bookBtn: { backgroundColor: '#00B14F', borderRadius: 14, paddingHorizontal: 22, paddingVertical: 14 },
