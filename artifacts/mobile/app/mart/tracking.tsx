...
const styles = StyleSheet.create({
  ...
  confirmedBanner: {
    ...
    backgroundColor: '#00B14F', borderRadius: 16, padding: 16, marginBottom: 12,
  },
  confirmedIcon: {
  ...
  confirmedText: {},
  confirmedTitle: { fontSize: 18, fontFamily: 'Inter_700Bold', color: '#FFFFFF' },
  confirmedSub: { fontSize: 13, fontFamily: 'Inter_400Regular', color: '#CCFFDD', marginTop: 2 },
  ...
  etaTime: { fontSize: 24, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  ...
  stepLabel: { fontSize: 10, fontFamily: 'Inter_400Regular', color: '#BBBBBB', marginTop: 4, textAlign: 'center' },
  stepLabelActive: { color: '#00B14F', fontFamily: 'Inter_600SemiBold' },
  trackerLine: { flex: 1, height: 3, backgroundColor: '#E0E0E0', marginTop: 16, marginHorizontal: 2 },
  trackerLineDone: { backgroundColor: '#00B14F' },
  trackerNote: { fontSize: 12, fontFamily: 'Inter_400Regular', color: '#9A9A9A' },
  ...
  riderRatingText: { fontSize: 12, fontFamily: 'Inter_400Regular', color: '#9A9A9A' },
  ...
  summaryTitle: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#1A1A1A', marginBottom: 12 },
  ...
  continueBtn: {
    backgroundColor: '#FFFFFF', borderRadius: 14, borderWidth: 1.5, borderColor: '#00B14F',
    alignItems: 'center', paddingVertical: 15,
  },
  continueBtnText: { fontSize: 15, fontFamily: 'Inter_700Bold', color: '#00B14F' },
});
