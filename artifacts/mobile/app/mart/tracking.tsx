...
const styles = StyleSheet.create({
  ...
  confirmedText: {},
  confirmedTitle: { fontSize: 18, fontFamily: 'PlusJakartaSans_700Bold', color: '#FFFFFF' },
  confirmedSub: { fontSize: 13, fontFamily: 'PlusJakartaSans_400Regular', color: '#CCFFDD', marginTop: 2 },
  ...
  etaTime: { fontSize: 24, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A' },
  ...
  stepLabel: { fontSize: 10, fontFamily: 'PlusJakartaSans_400Regular', color: '#BBBBBB', marginTop: 4, textAlign: 'center' },
  stepLabelActive: { color: '#00B14F', fontFamily: 'PlusJakartaSans_600SemiBold' },
  trackerLine: { flex: 1, height: 3, backgroundColor: '#E0E0E0', marginTop: 16, marginHorizontal: 2 },
  trackerLineDone: { backgroundColor: '#00B14F' },
  trackerNote: { fontSize: 12, fontFamily: 'PlusJakartaSans_400Regular', color: '#9A9A9A' },
  ...
  riderInfo: { flex: 1 },
  riderName: { fontSize: 15, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A' },
  riderRating: { flexDirection: 'row', alignItems: 'center', marginTop: 3 },
  riderRatingText: { fontSize: 12, fontFamily: 'PlusJakartaSans_400Regular', color: '#9A9A9A' },
  ...
  summaryTitle: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A', marginBottom: 12 },
  ...
  continueBtnText: { fontSize: 15, fontFamily: 'PlusJakartaSans_700Bold', color: '#00B14F' },
});
