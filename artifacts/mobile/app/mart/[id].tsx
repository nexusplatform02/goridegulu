...
const styles = StyleSheet.create({
  ...
  discountText: { fontSize: 13, fontFamily: 'PlusJakartaSans_700Bold', color: '#FFFFFF' },
  ...
  categoryText: { fontSize: 11, fontFamily: 'PlusJakartaSans_600SemiBold', color: '#00B14F' },
  productName: { fontSize: 22, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A' },
  unitText: { fontSize: 13, color: '#9A9A9A', fontFamily: 'PlusJakartaSans_400Regular', marginTop: -6 },
  priceRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  price: { fontSize: 26, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A' },
  ...
  saveText: { fontSize: 11, fontFamily: 'PlusJakartaSans_700Bold', color: '#00B14F' },

  sectionLabel: { fontSize: 14, fontFamily: 'PlusJakartaSans_600SemiBold', color: '#1A1A1A' },
  ...
  qtyText: { fontSize: 18, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A', minWidth: 24, textAlign: 'center' },
  ...
  infoTitle: { fontSize: 12, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A' },
  infoSub: { fontSize: 11, color: '#9A9A9A', fontFamily: 'PlusJakartaSans_400Regular' },
  ...
  addBtnText: { fontSize: 15, fontFamily: 'PlusJakartaSans_700Bold', color: '#FFFFFF' },
  outOfStockMsg: { flex: 1, textAlign: 'center', fontSize: 14, fontFamily: 'PlusJakartaSans_500Medium', color: '#9A9A9A' },
});
