...
const styles = StyleSheet.create({
  ...
  discountText: { fontSize: 13, fontFamily: 'Inter_700Bold', color: '#FFFFFF' },
  ...
  categoryPill: {
    alignSelf: 'flex-start', backgroundColor: '#E8F5EE', borderRadius: 8,
    paddingHorizontal: 10, paddingVertical: 4,
  },
  categoryText: { fontSize: 11, fontFamily: 'Inter_600SemiBold', color: '#00B14F' },
  productName: { fontSize: 22, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  unitText: { fontSize: 13, color: '#9A9A9A', fontFamily: 'Inter_400Regular', marginTop: -6 },
  priceRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  price: { fontSize: 26, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  originalPrice: { fontSize: 16, color: '#BBBBBB', textDecorationLine: 'line-through', fontFamily: 'Inter_400Regular' },
  savePill: { backgroundColor: '#E8F5EE', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4 },
  saveText: { fontSize: 11, fontFamily: 'Inter_700Bold', color: '#00B14F' },

  sectionLabel: { fontSize: 14, fontFamily: 'Inter_600SemiBold', color: '#1A1A1A' },
  ...
  qtyText: { fontSize: 18, fontFamily: 'Inter_700Bold', color: '#1A1A1A', minWidth: 24, textAlign: 'center' },
  ...
  infoTitle: { fontSize: 12, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  infoSub: { fontSize: 11, color: '#9A9A9A', fontFamily: 'Inter_400Regular' },
  ...
  addBtn: {
    ...
    backgroundColor: '#00B14F', borderRadius: 14, paddingHorizontal: 24, paddingVertical: 14,
  },
  addBtnText: { fontSize: 15, fontFamily: 'Inter_700Bold', color: '#FFFFFF' },
  outOfStockMsg: { flex: 1, textAlign: 'center', fontSize: 14, fontFamily: 'Inter_500Medium', color: '#9A9A9A' },
});
