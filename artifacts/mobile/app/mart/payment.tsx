...
const styles = StyleSheet.create({
  ...
  summaryStrip: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: '#FFFFFF', borderRadius: 14, padding: 14, marginBottom: 4,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 5, elevation: 2,
  },
  summaryLeft: { flex: 1 },
  summaryStore: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  ...
  sectionLabel: { fontSize: 13, fontFamily: 'Inter_600SemiBold', color: '#9A9A9A', marginTop: 16, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  billCard: {
    backgroundColor: '#FFFFFF', borderRadius: 14, padding: 16, marginTop: 4,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 5, elevation: 2,
  },
