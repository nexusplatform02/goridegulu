...
export default function MartPaymentScreen() {
    ...
    <View style={styles.root}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={{ padding: 16, paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.summaryStrip}>
          <View style={styles.summaryLeft}>
            <Text style={styles.summaryStore}>FreshMart Express</Text>
            <Text style={styles.summarySub}>6 items  ·  ASAP delivery</Text>
          </View>
          <Text style={styles.summaryTotal}>$18.80</Text>
        </View>
        ...
        <View style={styles.billCard}>
          ...
          {[['Subtotal', '$15.50'], ['Delivery fee', '$2.50'], ['Service fee', '$0.80']].map(([k, v]) => (
      ...
      <View style={[styles.bottomBar, { paddingBottom: Math.max(insets.bottom, 20) }]}>
        <TouchableOpacity
          style={styles.payBtn}
          activeOpacity={0.88}
          onPress={() => router.replace('/mart/tracking')}
        >
          <Text style={styles.payBtnText}>
            {selected === 'cash' ? 'Place Order' : 'Pay $18.80'}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
...
const styles = StyleSheet.create({
  ...
  summaryStrip: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: '#FFFFFF', borderRadius: 22, padding: 14, marginBottom: 4,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 5, elevation: 2,
  },
  summaryLeft: { flex: 1 },
  summaryStore: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold', color: '#1A1A1A' },
  ...
  sectionLabel: { fontSize: 13, fontFamily: 'PlusJakartaSans_600SemiBold', color: '#9A9A9A', marginTop: 16, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  billCard: {
    backgroundColor: '#FFFFFF', borderRadius: 22, padding: 16, marginTop: 4,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 5, elevation: 2,
  },
