...
const styles = StyleSheet.create({
  ...
  defaultPill: { backgroundColor: '#E8F5EE', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2 },
  defaultText: { fontSize: 10, fontFamily: 'Inter_600SemiBold', color: '#00B14F' },
  addressSub: { fontSize: 12, color: '#9A9A9A', fontFamily: 'Inter_400Regular', lineHeight: 18 },
  addAddressRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 12, paddingHorizontal: 4 },
  addAddressText: { fontSize: 13, fontFamily: 'Inter_500Medium', color: '#00B14F' },
  ...
  deliveryText: { flex: 1 },
  deliveryLabel: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  deliverySub: { fontSize: 12, fontFamily: 'Inter_400Regular', color: '#9A9A9A', marginTop: 2 },
  deliveryPrice: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#1A1A1A', marginRight: 8 },
  radio: {
  ...
  itemName: { flex: 1, fontSize: 13, fontFamily: 'Inter_400Regular', color: '#5A5A5A' },
  itemPrice: { fontSize: 13, fontFamily: 'Inter_600SemiBold', color: '#1A1A1A' },

  billCard: {
    backgroundColor: '#FFFFFF', borderRadius: 14, padding: 16, marginTop: 10,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 5, elevation: 2,
  },
