...
const styles = StyleSheet.create({
  ...
  flashTitle: { fontSize: 16, fontFamily: 'Inter_700Bold', color: '#1A1A1A' },
  countdown: {
    backgroundColor: '#E53935', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3,
  },
  countdownText: { fontSize: 12, fontFamily: 'Inter_700Bold', color: '#FFFFFF' },
  seeAll: { fontSize: 13, color: '#00B14F', fontFamily: 'Inter_500Medium' },
  dealCard: {
    width: 150, height: 100, borderRadius: 14, overflow: 'hidden',
  ...
  dealBadgeText: { fontSize: 11, fontFamily: 'Inter_700Bold', color: '#FFFFFF' },
  ...
  catText: { fontSize: 13, fontFamily: 'Inter_500Medium', color: '#5A5A5A' },
  ...
  discountBadge: {
    ...
    backgroundColor: '#E53935', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 3,
  },
  discountText: { fontSize: 10, fontFamily: 'Inter_700Bold', color: '#FFFFFF' },
  heartBtn: {
    position: 'absolute', top: 8, right: 8,
    width: 28, height: 28, borderRadius: 14, backgroundColor: '#FFFFFFDD',
    alignItems: 'center', justifyContent: 'center',
  },
  productBody: { padding: 10, gap: 3 },
  productBrand: { fontSize: 10, color: '#8A8A8A', fontFamily: 'Inter_400Regular', textTransform: 'uppercase' },
  productName: { fontSize: 12, fontFamily: 'Inter_600SemiBold', color: '#1A1A1A', lineHeight: 17 },
  ratingRow: { flexDirection: 'row', alignItems: 'center' },
  ratingText: { fontSize: 10, color: '#8A8A8A', fontFamily: 'Inter_400Regular' },
  priceRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 2 },
  price: { fontSize: 14, fontFamily: 'Inter_700Bold', color: '#E53935' },
  originalPrice: { fontSize: 10, color: '#BBBBBB', textDecorationLine: 'line-through', fontFamily: 'Inter_400Regular' },
  addCartBtn: {
    backgroundColor: '#00B14F', borderRadius: 10, paddingVertical: 7,
    alignItems: 'center', marginTop: 6,
  },
  addCartText: { fontSize: 12, fontFamily: 'Inter_600SemiBold', color: '#FFFFFF' },
});
