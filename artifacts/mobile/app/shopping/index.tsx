...
const styles = StyleSheet.create({
  ...
  flashTitle: { fontSize: 16, fontFamily: 'Aeonik-Bold', color: '#1A1A1A' },
  countdown: {
    backgroundColor: '#E53935', borderRadius: 28, paddingHorizontal: 8, paddingVertical: 3,
  },
  countdownText: { fontSize: 12, fontFamily: 'Aeonik-Bold', color: '#FFFFFF' },
  ...
  dealBadgeText: { fontSize: 11, fontFamily: 'Aeonik-Bold', color: '#FFFFFF' },
  ...
  catText: { fontSize: 13, fontFamily: 'Aeonik-Medium', color: '#5A5A5A' },
  ...
  discountText: { fontSize: 10, fontFamily: 'Aeonik-Bold', color: '#FFFFFF' },
  heartBtn: {
  ...
  productBrand: { fontSize: 10, color: '#8A8A8A', fontFamily: 'Aeonik-Regular', textTransform: 'uppercase' },
  productName: { fontSize: 12, fontFamily: 'Aeonik-Medium', color: '#1A1A1A', lineHeight: 17 },
  ratingRow: { flexDirection: 'row', alignItems: 'center' },
  ratingText: { fontSize: 10, color: '#8A8A8A', fontFamily: 'Aeonik-Regular' },
  priceRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 2 },
  price: { fontSize: 14, fontFamily: 'Aeonik-Bold', color: '#E53935' },
  originalPrice: { fontSize: 10, color: '#BBBBBB', textDecorationLine: 'line-through', fontFamily: 'Aeonik-Regular' },
  addCartBtn: {
    backgroundColor: '#00B14F', borderRadius: 22, paddingVertical: 7,
    alignItems: 'center', marginTop: 6,
  },
  addCartText: { fontSize: 12, fontFamily: 'Aeonik-Medium', color: '#FFFFFF' },
});
